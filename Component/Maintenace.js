...
const Maintenace = ({navigation}) => {
  ...
  const fetchMaintenance = async _id => {
    ...
    const response = await fetch(
      'https://officer-reports-backend.onrender.com/api/type/getAll?category=Maintenance',
      {
        method: 'GET',
        headers: {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(
        'https://officer-reports-backend.onrender.com/api/maintenance-report/add',
        {
          method: 'POST',
          body: formData,
          headers: {
        ...
        <View>
          ...
          <View style={style.textfieldandtextarseview}>
            ...
            <View style={style.maindropdownview}>
              <View style={style.dropdownmenuandiconview}>
                <Picker
                  selectedValue={emailClient}
                  onValueChange={itemValue => setemailClient(itemValue)}
                  style={style.dropdownheadingtext}>
