              ...
              {data.length > 0 ? (
                data.map(entry => (
                  <TouchableOpacity
                    ...
                    <Text>
                      <Text style={style.onltfontweight}>Driver: </Text>
                      {entry.inDriver}
                    </Text>
                    <Text>
                      <Text style={style.onltfontweight}>Tractor #: </Text>
                      {entry.tractorNumber}
                    </Text>
                  </TouchableOpacity>
                ))
            ...
            <View style={style.logdatamodalview}>
              {selectedLog ? (
                <>
                  ...
                  <Text>
                    <Text style={style.onltfontweight}>Inbound Driver: </Text>
                    {selectedLog.inDriver}
                  </Text>
                  <Text>
                    <Text style={style.onltfontweight}>Tractor : </Text>
                    {selectedLog.tractorNumber}
                  </Text>
                  <Text>
                    <Text style={style.onltfontweight}>LP : </Text>
                    {selectedLog.LPNumber}
                  </Text>
                  <Text>
                    <Text style={style.onltfontweight}>VIN : </Text>
                    {selectedLog.VIN}
                  </Text>

                  <View style={style.mainviewfortru8chmodalandtext}>
                    <View style={{ width: '30%' }}>
                      <Text style={style.bdgwdndwedm}>
                        Outbound Driver :{' '}
                      </Text>
                    </View>
                    <TextInput
                      style={style.textinputfortruckmodal}
                      value={outDriver}
                  ...
                  <View style={style.mainviewfortru8chmodalandtext}>
                    <View style={{ width: '30%' }}>
                      <Text style={style.bdgwdndwedm}>Trailer # : </Text>
                    </View>
                    <TextInput
                      style={style.textinputfortruckmodal}
                  ...
                  <View style={style.mainviewfortru8chmodalandtext}>
                    <View style={{ width: '30%' }}>
                      <Text style={style.bdgwdndwedm}>Seal Number : </Text>
                    </View>
                    <TextInput
                      style={style.textinputfortruckmodal}
                      value={outSealNumber}
                  ...
                  <View style={style.mainviewfortru8chmodalandtext}>
                    <View style={{ width: '30%' }}>
                      <Text style={style.bdgwdndwedm}>Notes on Exit : </Text>
                    </View>
                    <Textarea
