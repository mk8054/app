...
const PostOrders = ({navigation}) => {
    ...
    const fetchSiteDetails = async (siteId) => {
        try {
            const response = await fetch(`https://officer-reports-backend.onrender.com/api/site/get/${siteId}`);
        ...
        <ScrollView style={style.MainScrollView}>
            ...
            <View>
                ...
                <View style={style.officerandsitesection}>
                    ...
                    <View style={style.officernameandsiteandlcinwetvalue}>
                        <Text><Text style={style.onltfontweight}>Address1: </Text>{siteDetails.address1}</Text>
                        <Text><Text style={style.onltfontweight}>Address2: </Text>{siteDetails.address2}</Text>
                        <Text><Text style={style.onltfontweight}>City/State/PostalCode: </Text>{`${siteDetails.city}/${siteDetails.state}/${siteDetails.postalCode}`}</Text>
                    </View>
                </View>
                <View style={style.officerandsitesection}>
                    <View style={style.viewforbgcandtext}>
                    ...
                    <View style={style.officernameandsiteandlcinwetvalue}>
                        <Text><Text style={style.onltfontweight}>ClientContact: </Text>{siteDetails.clientContact}</Text>
                        <Text><Text style={style.onltfontweight}>Phone: </Text>{siteDetails.clientPhone}</Text>
                    </View>
                </View>
                <View style={style.officerandsitesection}>
                    <View style={style.viewforbgcandtext}>
                    ...
                    <View style={style.officernameandsiteandlcinwetvalue}>
                        <Text><Text style={style.onltfontweight}>MaintenanceContact: </Text>{siteDetails.maintenance}</Text>
                        <Text><Text style={style.onltfontweight}>Phone: </Text>{siteDetails.maintenancePhone}</Text>
                    </View>
                </View>
                <View style={style.officerandsitesection}>
                    <View style={style.viewforbgcandtext}>
                    ...
                    <View style={style.officernameandsiteandlcinwetvalue}>
                        <Text><Text style={style.onltfontweight}>PoliceContact: </Text>{siteDetails.policeContact}</Text>
                        <Text><Text style={style.onltfontweight}>Phone: </Text>{siteDetails.policePhone}</Text>
                    </View>
                </View>
                <View style={style.officerandsitesection}>
                    <View style={style.viewforbgcandtext}>
                    ...
                    <View style={style.officernameandsiteandlcinwetvalue}>
                        <Text><Text style={style.onltfontweight}>TowingContact: </Text>{siteDetails.towingContact}</Text>
                        <Text><Text style={style.onltfontweight}>Phone: </Text>{siteDetails.towingPhone}</Text>
                    </View>
                </View>
                <View style={style.officerandsitesection}>
                    <View style={style.viewforbgcandtext}>
                    ...
                    <View style={style.officernameandsiteandlcinwetvalue}>
                        <Text><Text style={style.onltfontweight}>PostOrderComments: </Text>{siteDetails.postOrderComments}</Text>
                    </View>
                </View>
            </View>
        </ScrollView>
