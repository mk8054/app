        ...
        <View>
          <View style={style.viewforiconandtextindailyreport}>
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('Worksite')}>
              <FontAwesomeIcon
          ...
          <View style={style.getallsitesmainview}>
            <TouchableOpacity
              style={style.TouchableOpacityfortextandimage}
            ...
            <TouchableOpacity
              ...
              <View style={style.viewforimageinreport}>
                <Image
                  style={style.reportofofficerpasge}
                  source={require('../assets/images/personandpen2.png')}
                />
              </View>
            </TouchableOpacity>
            <TouchableOpacity
              style={style.TouchableOpacityfortextandimage}
              onPress={() => navigation.navigate('FieldInspection')}>
            ...
            <TouchableOpacity
              ...
              <View style={style.viewforimageinreport}>
                <Image
                  style={style.reportofofficerpasge}
                  source={require('../assets/images/personminus.png')}
                />
              </View>
            </TouchableOpacity>
            <TouchableOpacity
              style={style.TouchableOpacityfortextandimage}
              onPress={() => navigation.navigate('Incidentchecklist')}>
            ...
            <TouchableOpacity
              style={style.TouchableOpacityfortextandimage}
              onPress={() => navigation.navigate('Maintenace')}>
              <Text style={style.nameofreport}>Maintenance Report</Text>
              <View style={style.viewforimageinreport}>
                <Image
                  style={style.reportofofficerpasge}
                  source={require('../assets/images/maintenancereport.png')}
                />
              </View>
            </TouchableOpacity>
            <TouchableOpacity
              style={style.TouchableOpacityfortextandimage}
              onPress={() => navigation.navigate('ParkingViolation')}>
              <Text style={style.nameofreport}>Parking Violation</Text>
              <View style={style.viewforimageinreport}>
                <Image
                  style={style.reportofofficerpasge}
                  source={require('../assets/images/Biggextptext.png')}
                />
              </View>
            </TouchableOpacity>
            <TouchableOpacity
              style={style.TouchableOpacityfortextandimage}
              onPress={() => navigation.navigate('ParkingViolationSearch')}>
            ...
            <TouchableOpacity
              style={style.TouchableOpacityfortextandimage}
              onPress={() => navigation.navigate('Passonlogentry')}>
              <Text style={style.nameofreport}>Pass on Log - Write</Text>
              <View style={style.viewforimageinreport}>
                <Image
                  style={style.reportofofficerpasge}
                  source={require('../assets/images/passonwrite.png')}
                />
              </View>
            </TouchableOpacity>
            <TouchableOpacity
              style={style.TouchableOpacityfortextandimage}
              onPress={() => navigation.navigate('PassOnLog')}>
              <Text style={style.nameofreport}>Pass on Log - Read</Text>
              <View style={style.viewforimageinreport}>
                <Image
                  style={style.reportofofficerpasge}
                  source={require('../assets/images/logonread.png')}
                />
              </View>
            </TouchableOpacity>
            <TouchableOpacity
              style={style.TouchableOpacityfortextandimage}
              onPress={() => navigation.navigate('Policymanual')}>
              <Text style={style.nameofreport}>Policy Manual</Text>
              <View style={style.viewforimageinreport}>
                <Image
                  style={style.reportofofficerpasge}
                  source={require('../assets/images/policy-manual.png')}
                />
              </View>
            </TouchableOpacity>
            <TouchableOpacity
            ...
            <TouchableOpacity
              style={style.TouchableOpacityfortextandimage}
              onPress={() => navigation.navigate('TemperatureLog')}>
            ...
            <TouchableOpacity
              style={style.TouchableOpacityfortextandimage}
              onPress={() => navigation.navigate('Truckcheckin')}>
              <Text style={style.nameofreport}>Truck Check - in</Text>
              <View style={style.viewforimageinreport}>
                <Image
                  style={style.reportofofficerpasge}
                  source={require('../assets/images/truckin.png')}
                />
              </View>
            </TouchableOpacity>
            <TouchableOpacity
              style={style.TouchableOpacityfortextandimage}
              onPress={() => navigation.navigate('TruckCheckOut')}>
              <Text style={style.nameofreport}>Truck Check - Out</Text>
              <View style={style.viewforimageinreport}>
                <Image
                  style={style.reportofofficerpasge}
                  source={require('../assets/images/truckout.png')}
                />
              </View>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              <View style={style.viewforimageinreport}>
                <Image
                  style={style.reportofofficerpasge}
                  source={require('../assets/images/vacation-request.png')}
                />
              </View>
            </TouchableOpacity>
            <TouchableOpacity
              style={style.TouchableOpacityfortextandimage}
              onPress={() => navigation.navigate('VacationReview')}>
              <Text style={style.nameofreport}>Vacation Review</Text>
              <View style={style.viewforimageinreport}>
                <Image
                  style={style.reportofofficerpasge}
                  source={require('../assets/images/april.png')}
                />
              </View>
            </TouchableOpacity>
            <TouchableOpacity
            ...
            <TouchableOpacity
              style={style.TouchableOpacityfortextandimage}
              onPress={() => navigation.navigate('Visitorcheckout')}>
