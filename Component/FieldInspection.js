...
import { ScrollView, Text, View, TouchableOpacity, Image, TextInput, PermissionsAndroid, Platform, Alert } from 'react-native';
...
const FieldInspection = ({ navigation }) => {
    ...
    const handleSubmit = async () => {
        ...
        // Add observation attachments
        addedObservations.forEach((id, index) => {
            formData.append(`officerAttachments[${index}]`, id);
        });

        // Add media files for officer attachments
        for (const [index, uri] of media.entries()) {
            const fileType = uri.split('.').pop();
            const response = await fetch(uri);
            const blob = await response.blob();
            formData.append(`officerAttachments[${index}]`, {
        ...
        addedObservationstwo.forEach((id, index) => {
            formData.append(`vehicleAttachments[${index}]`, id);
        });

        // Add media files for vehicle attachments
        for (const [index, uri] of mediatwo.entries()) {
            const fileType = uri.split('.').pop();
            const response = await fetch(uri);
            const blob = await response.blob();
            formData.append(`vehicleAttachments[${index}]`, {
                name: `media_${index}.${fileType}`,
                type: `image/${fileType}`,
                uri,
            });
        ...
        try {
            ...
            const response = await fetch('https://officer-reports-backend.onrender.com/api/field-inspection/add', {
                method: 'POST',
                body: formData,
                headers: {
            ...
            Alert.alert('Error', `There was an error submitting the form: ${error.message}`);
        }
    };
                ...
                <View>
                    ...
                    <View style={style.textfieldandtextarseview}>
                        ...
                        <View style={style.alertsectionradiobutnview}>
                            <View style={style.radioButtonContainer}>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="true" status={distracted === 'true' ? 'checked' : 'unchecked'} onPress={() => setdistracted('true')} />
                                    <Text style={style.radioButtonText}>Yes</Text>
                                </View>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="false" status={distracted === 'false' ? 'checked' : 'unchecked'} onPress={() => setdistracted('false')} />
                                    <Text style={style.radioButtonText}>No</Text>
                                </View>
                            </View>
                        </View>
                    ...
                    <View style={style.textfieldandtextarseview}>
                        ...
                        <View style={style.alertsectionradiobutnview}>
                            <View style={style.radioButtonContainer}>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="true" status={properUniform === 'true' ? 'checked' : 'unchecked'} onPress={() => setproperUniform('true')} />
                                    <Text style={style.radioButtonText}>Yes</Text>
                                </View>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="false" status={properUniform === 'false' ? 'checked' : 'unchecked'} onPress={() => setproperUniform('false')} />
                                    <Text style={style.radioButtonText}>No</Text>
                                </View>
                            </View>
                        </View>
                    ...
                    <View style={style.textfieldandtextarseview}>
                        ...
                        <View style={style.alertsectionradiobutnview}>
                            <View style={style.radioButtonContainer}>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="true" status={properlyGroomed === 'true' ? 'checked' : 'unchecked'} onPress={() => setproperlyGroomed('true')} />
                                    <Text style={style.radioButtonText}>Yes</Text>
                                </View>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="false" status={properlyGroomed === 'false' ? 'checked' : 'unchecked'} onPress={() => setproperlyGroomed('false')} />
                                    <Text style={style.radioButtonText}>No</Text>
                                </View>
                            </View>
                        </View>
                    ...
                    <View style={style.textfieldandtextarseview}>
                        ...
                        <View style={style.alertsectionradiobutnview}>
                            <View style={style.radioButtonContainer}>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="true" status={validLicenses === 'true' ? 'checked' : 'unchecked'} onPress={() => setvalidLicenses('true')} />
                                    <Text style={style.radioButtonText}>Yes</Text>
                                </View>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="false" status={validLicenses === 'false' ? 'checked' : 'unchecked'} onPress={() => setvalidLicenses('false')} />
                                    <Text style={style.radioButtonText}>No</Text>
                                </View>
                            </View>
                        </View>
                    ...
                    <View style={style.textfieldandtextarseview}>
                        ...
                        <View style={style.alertsectionradiobutnview}>
                            <View style={style.radioButtonContainer}>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="true" status={DARCompleted === 'true' ? 'checked' : 'unchecked'} onPress={() => setDARCompleted('true')} />
                                    <Text style={style.radioButtonText}>Yes</Text>
                                </View>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="false" status={DARCompleted === 'false' ? 'checked' : 'unchecked'} onPress={() => setDARCompleted('false')} />
                                    <Text style={style.radioButtonText}>No</Text>
                                </View>
                            </View>
                        </View>
                    ...
                    <View style={style.textfieldandtextarseview}>
                        ...
                        <View style={style.alertsectionradiobutnview}>
                            <View style={style.radioButtonContainer}>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="true" status={knowPostOrders === 'true' ? 'checked' : 'unchecked'} onPress={() => setknowPostOrders('true')} />
                                    <Text style={style.radioButtonText}>Yes</Text>
                                </View>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="false" status={knowPostOrders === 'false' ? 'checked' : 'unchecked'} onPress={() => setknowPostOrders('false')} />
                                    <Text style={style.radioButtonText}>No</Text>
                                </View>
                            </View>
                        </View>
                    ...
                    <View style={style.textfieldandtextarseview}>
                        ...
                        <View style={style.alertsectionradiobutnview}>
                            <View style={style.radioButtonContainer}>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="true" status={adminQuestions === 'true' ? 'checked' : 'unchecked'} onPress={() => setadminQuestions('true')} />
                                    <Text style={style.radioButtonText}>Yes</Text>
                                </View>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="false" status={adminQuestions === 'false' ? 'checked' : 'unchecked'} onPress={() => setadminQuestions('false')} />
                                    <Text style={style.radioButtonText}>No</Text>
                                </View>
                            </View>
                        </View>
                    ...
                    <View style={style.textfieldandtextarseview}>
                        ...
                        <View style={style.alertsectionradiobutnview}>
                            <View style={style.radioButtonContainer}>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="true" status={vehicleGoodCondition === 'true' ? 'checked' : 'unchecked'} onPress={() => setvehicleGoodCondition('true')} />
                                    <Text style={style.radioButtonText}>Yes</Text>
                                </View>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="false" status={vehicleGoodCondition === 'false' ? 'checked' : 'unchecked'} onPress={() => setvehicleGoodCondition('false')} />
                                    <Text style={style.radioButtonText}>No</Text>
                                </View>
                            </View>
                        </View>
                    ...
                    <View style={style.textfieldandtextarseview}>
                        ...
                        <View style={style.viewforredlineandaddbutton}>
                            <TouchableOpacity onPress={pickMediatwo} style={style.addobservationtouchopcay}>
                                <FontAwesomeIcon style={{ marginLeft: 5 }} icon={faCirclePlus} />
                                <Text style={style.addobservationtext}> Add Photo, Video, or Audio</Text>
                            </TouchableOpacity>
                        </View>
                    ...
                    <View>
                        <View style={style.mainviewforimageanddeleticon}>
                            {Array.isArray(mediatwo) && mediatwo.length > 0 && mediatwo.map((uri, index) => (
                                <View key={index} style={style.mediaimageview}>
                                    <Image source={{ uri }} style={style.mediaimage} />
                                    <TouchableOpacity onPress={() => deleteImagetwo(uri)} style={style.mediaimagedeleteiocnview}>
                                        <FontAwesomeIcon icon={faXmark} size={18} color="#dc311c" />
                                    </TouchableOpacity>
                                </View>
                            ))}
                    ...
                    <View style={style.textfieldandtextarseview}>
                        ...
                        <View style={style.alertsectionradiobutnview}>
                            <View style={style.radioButtonContainer}>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="true" status={vehicleServiceRequired === 'true' ? 'checked' : 'unchecked'} onPress={() => setvehicleServiceRequired('true')} />
                                    <Text style={style.radioButtonText}>Yes</Text>
                                </View>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="false" status={vehicleServiceRequired === 'false' ? 'checked' : 'unchecked'} onPress={() => setvehicleServiceRequired('false')} />
                                    <Text style={style.radioButtonText}>No</Text>
                                </View>
                            </View>
                        </View>
                    ...
                    <View style={style.textfieldandtextarseview}>
                        ...
                        <View style={style.alertsectionradiobutnview}>
                            <View style={style.radioButtonContainer}>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="true" status={vehicleDocsPresent === 'true' ? 'checked' : 'unchecked'} onPress={() => setvehicleDocsPresent('true')} />
                                    <Text style={style.radioButtonText}>Yes</Text>
                                </View>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="false" status={vehicleDocsPresent === 'false' ? 'checked' : 'unchecked'} onPress={() => setvehicleDocsPresent('false')} />
                                    <Text style={style.radioButtonText}>No</Text>
                                </View>
                            </View>
                        </View>
                    ...
                    <View style={style.textfieldandtextarseview}>
                        ...
                        <View style={style.alertsectionradiobutnview}>
                            <View style={style.radioButtonContainer}>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="true" status={meetClient === 'true' ? 'checked' : 'unchecked'} onPress={() => setmeetClient('true')} />
                                    <Text style={style.radioButtonText}>Yes</Text>
                                </View>
                                <View style={style.radioButtonContainer}>
                                    <RadioButton value="false" status={meetClient === 'false' ? 'checked' : 'unchecked'} onPress={() => setmeetClient('false')} />
                                    <Text style={style.radioButtonText}>No</Text>
                                </View>
                            </View>
                        </View>
