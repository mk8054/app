  ...
  const Getvisitordata = async () => {
    try {
      ...
      const response = await fetch(
        `https://officer-reports-backend.onrender.com/api/visitor/getByUserId/${userID}?isCheckOut=false`,
        {
          method: 'GET',
          headers: {
          ...
          {visitordata.length > 0 ? (
            visitordata.map(entry => (
              <TouchableOpacity
                ...
                onPress={() => selectVisitorLog(entry)}>
                <Text>
                ...
                <Text>
                  ...
                  {new Date(entry.inDate).toLocaleDateString()}
                </Text>
                <Text>
                ...
                <Text>
                  <Text style={style.onltfontweight}>Notes : </Text>
                  {entry.destination}
                </Text>
              </TouchableOpacity>
            ))
            ...
            <View style={style.modalforaddtrucklog}>
              ...
              <View style={style.logdatamodalview}>
                <View style={style.bothtextofmofdalview}>
                  <Text style={style.onltfontweight}>Visitor Name: </Text>
                  <Text style={style.textvaluevisitor}>
                ...
                <View style={style.bothtextofmofdalview}>
                  <Text style={style.onltfontweight}>Date: </Text>
                  <Text style={style.textvaluevisitor}>
                    {new Date(selectedLog.inDate).toLocaleDateString()}
                  </Text>
                </View>
                <View style={style.bothtextofmofdalview}>
                  <Text style={style.onltfontweight}>Company: </Text>
