...
const ParkingViolation = ({ navigation }) => {
    ...
    const handlesubmit = async () => {
        ...
        try {
            const response = await fetch('https://officer-reports-backend.onrender.com/api/parking-violation/add', {
                method: 'POST',
                body: formData,
                headers: {
                    'Authorization': `Bearer ${token}`,
    ...
    return (
        <ScrollView style={style.MainScrollView}>
            ...
            <View>
                ...
                <View style={style.officerandsitesection}>
                    <View style={style.viewforbgcandtext}>
                        <Text style={style.headingtextfordailyactivey}>Parking Violation Info</Text>
                    </View>
                    ...
                    <View style={style.textfieldandtextarseview}>
                        ...
                        <View style={style.maindropdownview}>
                            <View style={style.dropdownmenuandiconview}>
                                <Picker selectedValue={vehicleTowed} onValueChange={(itemValue) => setvehicleTowed(itemValue)} style={style.dropdownheadingtext}>
                    ...
                    <View style={style.textfieldandtextarseview}>
                        ...
                        <View style={style.alertsectionradiobutnview}>
                            <View style={style.textareaviewofdescribe}>
                                <Textarea placeholder={''} value={detail}
