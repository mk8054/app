            ...
            data.map(entry => {
              ...
              return (
                <View key={_id} style={style.licensnceplacenumbeerview}>
                  <Text>
                    <Text style={style.onltfontweight}>Date Entered: </Text>
                    {new Date(createdAt).toLocaleDateString()}
                  </Text>
                  <Text>
                    <Text style={style.onltfontweight}>Start Date: </Text>
                    {new Date(startDate).toLocaleDateString()}
                  </Text>
                  <Text>
                    <Text style={style.onltfontweight}>End Date: </Text>
                    {new Date(endDate).toLocaleDateString()}
                  </Text>
                  <Text>
                    <Text style={style.onltfontweight}>Reason: </Text>
                    {reason}
                  </Text>
                  <Text>
                    <Text style={style.onltfontweight}>Status: </Text>
                    {vacationRequestStatus}
                  </Text>
                </View>
              );
