...
const Login = ({ navigation }) => {
    ...
    const handleLogin = async () => {
        try {
            const response = await fetch('https://officer-reports-backend.onrender.com/api/officer/login', {
                method: 'POST',
                headers: {
        ...
        <>
            <ScrollView style={style.MainScrollView}>
                ...
                <View style={style.loginpagetextcontent}>
                    <Text style={style.loginpageheadingtext}>Officer Portal Sign In</Text>
                    ...
                    <View style={style.textinputview}>
                        ...
                        <View style={style.passwordtextfield}>
                            ...
                            />
                            <TouchableOpacity style={style.eyeiconforlogin} onPress={() => setShowPassword(!showPassword)}>
                ...
                <View style={style.Modalbackgroundmainview}>
                    <View style={style.modalview}>
                        ...
                        <View style={style.selectoptionview}>
                            <TouchableOpacity style={style.modalsbutton} onPress={handleschedule}>
                                <Text style={style.viewscheduletext}>View Schedule</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={style.modalsbutton} onPress={handleworksites}>
