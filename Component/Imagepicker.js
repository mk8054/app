  ...
  return (
    <ScrollView style={{width: '90%', alignSelf: 'center', marginTop: 100}}>
      ...
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        ...
        <RadioButton
          value="yes"
          status={alert === 'yes' ? 'checked' : 'unchecked'}
          onPress={() => {
            setalert('yes');
            setalert('yes');
          }}
        ...
        <RadioButton
          value="no"
          status={alert === 'no' ? 'checked' : 'unchecked'}
          onPress={() => {
            setalert('no');
            setalert('no');
          }}
      ...
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        ...
        <RadioButton
          value="yes"
          status={distracted === 'yes' ? 'checked' : 'unchecked'}
          onPress={() => {
            setdistracted('yes');
            setdistracted('yes');
          }}
        ...
        <RadioButton
          value="no"
          status={distracted === 'no' ? 'checked' : 'unchecked'}
          onPress={() => {
            setdistracted('no');
            setdistracted('no');
          }}
      ...
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        ...
        <RadioButton
          value="yes"
          status={properUniform === 'yes' ? 'checked' : 'unchecked'}
          onPress={() => {
            setproperUniform('yes');
            setproperUniform('yes');
          }}
        />
        <Text>Yes</Text>
        <RadioButton
          value="no"
          status={properUniform === 'no' ? 'checked' : 'unchecked'}
          onPress={() => {
            setproperUniform('no');
            setproperUniform('no');
          }}
      ...
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        ...
        <RadioButton
          value="yes"
          status={validLicenses === 'yes' ? 'checked' : 'unchecked'}
          onPress={() => {
            setvalidLicenses('yes');
            setvalidLicenses('yes');
          }}
        />
        <Text>Yes</Text>
        <RadioButton
          value="no"
          status={validLicenses === 'no' ? 'checked' : 'unchecked'}
          onPress={() => {
            setvalidLicenses('no');
            setvalidLicenses('no');
          }}
      ...
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        ...
        <RadioButton
          value="yes"
          status={properlyGroomed === 'yes' ? 'checked' : 'unchecked'}
          onPress={() => {
            setproperlyGroomed('yes');
            setproperlyGroomed('yes');
          }}
        />
        <Text>Yes</Text>
        <RadioButton
          value="no"
          status={properlyGroomed === 'no' ? 'checked' : 'unchecked'}
          onPress={() => {
            setproperlyGroomed('no');
            setproperlyGroomed('no');
          }}
        />
        <Text>No</Text>
      ...
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        ...
        <RadioButton
          value="yes"
          status={DARCompleted === 'yes' ? 'checked' : 'unchecked'}
          onPress={() => {
            setDARCompleted('yes');
            setDARCompleted('yes');
          }}
        ...
        <RadioButton
          value="no"
          status={DARCompleted === 'no' ? 'checked' : 'unchecked'}
          onPress={() => {
            setDARCompleted('no');
            setDARCompleted('no');
          }}
      ...
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        ...
        <RadioButton
          value="yes"
          status={knowPostOrders === 'yes' ? 'checked' : 'unchecked'}
          onPress={() => {
            setknowPostOrders('yes');
            setknowPostOrders('yes');
          }}
        />
        <Text>Yes</Text>
        <RadioButton
          value="no"
          status={knowPostOrders === 'no' ? 'checked' : 'unchecked'}
          onPress={() => {
            setknowPostOrders('no');
            setknowPostOrders('no');
          }}
        />
        <Text>No</Text>
      ...
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        ...
        <RadioButton
          value="yes"
          status={adminQuestions === 'yes' ? 'checked' : 'unchecked'}
          onPress={() => {
            setadminQuestions('yes');
            setadminQuestions('yes');
          }}
        />
        <Text>Yes</Text>
        <RadioButton
          value="no"
          status={adminQuestions === 'no' ? 'checked' : 'unchecked'}
          onPress={() => {
            setadminQuestions('no');
            setadminQuestions('no');
          }}
        />
        <Text>No</Text>
      ...
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        ...
        <RadioButton
          value="yes"
          status={vehicleGoodCondition === 'yes' ? 'checked' : 'unchecked'}
          onPress={() => {
            setvehicleGoodCondition('yes');
            setvehicleGoodCondition('yes');
          }}
        />
        <Text>Yes</Text>
        <RadioButton
          value="no"
          status={vehicleGoodCondition === 'no' ? 'checked' : 'unchecked'}
          onPress={() => {
            setvehicleGoodCondition('no');
            setvehicleGoodCondition('no');
          }}
        />
        <Text>No</Text>
      ...
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        ...
        <RadioButton
          value="yes"
          status={vehicleServiceRequired === 'yes' ? 'checked' : 'unchecked'}
          onPress={() => {
            setvehicleServiceRequired('yes');
            setvehicleServiceRequired('yes');
          }}
        />
        <Text>Yes</Text>
        <RadioButton
          value="no"
          status={vehicleServiceRequired === 'no' ? 'checked' : 'unchecked'}
          onPress={() => {
            setvehicleServiceRequired('no');
            setvehicleServiceRequired('no');
          }}
        />
        <Text>No</Text>
      ...
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        ...
        <RadioButton
          value="yes"
          status={vehicleDocsPresent === 'yes' ? 'checked' : 'unchecked'}
          onPress={() => {
            setvehicleDocsPresent('yes');
            setvehicleDocsPresent('yes');
          }}
        />
        <Text>Yes</Text>
        <RadioButton
          value="no"
          status={vehicleDocsPresent === 'no' ? 'checked' : 'unchecked'}
          onPress={() => {
            setvehicleDocsPresent('no');
            setvehicleDocsPresent('no');
          }}
        />
        <Text>No</Text>
      ...
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        ...
        <RadioButton
          value="yes"
          status={meetClient === 'yes' ? 'checked' : 'unchecked'}
          onPress={() => {
            setmeetClient('yes');
            setmeetClient('yes');
          }}
        ...
        <RadioButton
          value="no"
          status={meetClient === 'no' ? 'checked' : 'unchecked'}
          onPress={() => {
            setmeetClient('no');
            setmeetClient('no');
          }}
