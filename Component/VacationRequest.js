...
const VacationRequest = ({ navigation }) => {
    ...
    const handleSubmit = async () => {
        ...
        const response = await fetch('https://officer-reports-backend.onrender.com/api/vacation/add', {
            method: 'POST',
            headers: {
    ...
    return (
        <ScrollView style={style.MainScrollView}>
            ...
            <View>
                ...
                <View style={style.officerandsitesection}>
                    <View style={style.viewforbgcandtext}>
                        <Text style={style.headingtextfordailyactivey}>Contact Details</Text>
                    </View>
