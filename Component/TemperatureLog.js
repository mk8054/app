...
const TemperatureLog = ({ navigation }) => {
    ...
    const fetchTypes = async () => {
        try {
            const response = await fetch('https://officer-reports-backend.onrender.com/api/type/getAll?category=Equipment');
    ...
    const handlesubmit = async () => {
        if (isNaN(temperature) || isNaN(humidity)) {
            Alert.alert("Invalid Input", "Temperature and Humidity must be numeric values.");
            return;
        }
        ...
        const response = await fetch('https://officer-reports-backend.onrender.com/api/temperatureLog/add', {
            method: 'POST',
            headers: {
    ...
    return (
        <ScrollView style={style.MainScrollView}>
            ...
            <View>
                ...
                <View style={style.officerandsitesection}>
                    <View style={style.viewforbgcandtext}>
                        <Text style={style.headingtextfordailyactivey}>Temperature Log</Text>
                    </View>
                    <View style={style.textfieldandtextarseview}>
                        ...
                        <View style={style.maindropdownview}>
                            <View style={style.dropdownmenuandiconview}>
                                <Picker selectedValue={equipmentTypeId} style={style.dropdownheadingtext} onValueChange={(itemValue) => setequipmentTypeId(itemValue)}>
                    ...
                    <View style={style.textfieldandtextarseview}>
                        ...
                        <View style={style.InspectedOfficerOtherview}>
                            <TextInput
                                ...
                                value={temperature}
                                onChangeText={text => settemperature(text.replace(/[^0-9.-]/g, ''))}
